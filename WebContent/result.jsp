					...
					<div class="profile_details">		
						  <div class="col-md-4 serch-part">
								...
								<script type="text/javascript">
									...
									function addOrCancle(sid,usid) {
										$.ajax({
											type : "post",
											url : "/Godvoice/addSongServlet",
											data : {
												"songid" : sid,
												"do" : "addtocollect",
												"usid" : usid
											...
											success : function (data) {
												if(data == "Login")
													location.href = "/Godvoice/login2.jsp"
											}
										});
									}
			...
			<div id="page-wrapper">
				...
				<div class="inner-content single">
						    ...
						    <div class="tittle-head">
									<h3 class="tittle">搜索结果</h3>
									<div class="clearfix"> </div>
							</div>
						   <div class="single_left" style="width : 100%">
                                     <ul class="list-group">
									<c:forEach items="${sonsigmap }" var="entry">
										<li class="list-group-item"> 
											<a href="/Godvoice/DisplayServlet?songid=${entry.key.songid }" target="player">${entry.value.signame } - ${entry.key.songname }</a>
											<button style="border:none; background: url('/Godvoice/images/like.png'); height: 16px; width: 17px" onclick="addOrCancle(${entry.key.songid},${user.usid });"></button>
										</li>
									</c:forEach>
								</ul>
				</div>
