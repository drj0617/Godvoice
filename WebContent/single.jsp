			...
			<div id="page-wrapper">
				...
				<div class="inner-content single">
						...
						<div class="tittle-head">
									<h3 class="tittle">${singer.signame }</h3>
									<div class="clearfix"> </div>
								</div>
						   <div class="single_left">
									...
									<c:forEach items="${songs }" var="song">
										<li class="list-group-item" >
											<a href="/Godvoice/DisplayServlet?songid=${song.songid }" target="player">${singer.signame } - ${song.songname }</a>
											<button style="border : 0px;background: url('/Godvoice/images/like.png'); height: 16px; width: 17px" onclick="addOrCancle(${song.songid},${user.usid });"></button>
										</li>
									</c:forEach>
								</ul>
				</div>
