			...
			<div id="page-wrapper">
				...
				<div class="inner-content single">
						...
						<div class="tittle-head">
									<h3 class="tittle">${album.albname}</h3>
									<div class="clearfix"> </div>
								</div>
						   <div class="single_left">
									...
									<c:forEach items="${songs }" var="song">
										<li class="list-group-item" >
											...
											<button style="border:none; background: url('/Godvoice/images/like.png'); height: 16px; width: 17px" onclick="addOrCancle(${song.songid},${user.usid });"></button>
										</li>
									</c:forEach>
								</ul>
				</div>
